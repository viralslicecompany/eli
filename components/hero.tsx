...
export default function Hero() {
  return (
    <div className="relative flex flex-col justify-end min-h-[500px] md:min-h-[800px] rounded-xl mx-4 md:mx-16 overflow-hidden bg-black">
      ...
      <div className="relative z-20 flex flex-col items-start justify-end h-full w-full px-4 md:px-10 pb-10 md:pb-16">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold drop-shadow-lg mb-4 md:mb-6">
      ...
      <div className="absolute bottom-4 right-4 md:bottom-6 md:right-6 z-30">
        <div className="w-48 md:w-64 rounded-xl overflow-hidden shadow-2xl border border-white/10 bg-white/10 backdrop-blur-md">
